...
public class movii {
    private static final Logger LOGGER = Logger.getLogger(movii.class.getName());
    public static void main(String[] args)throws Exception {
        Handler fileHandler = new FileHandler("C:\\Users\\sapna.goyal\\movies.log");
        ...
        while (i != 0) {
            ...
            if (choice == 1) {
                ...
                Movie movie = movi.service.TopMovie.topMovieByGenre(genreId, movieList, ratingList, LOGGER);
            ...
            if (choice == 2) {
                ...
                Movie movie = movi.service.TopMovie.topMoviesByYear(year, movieList, ratingList, LOGGER);
                if (movie != null)
                    System.out.println(movie.getMovieId() + " " + movie.getMovieTitle());
            }
            ...
            if (choice == 3) {
                ...
                Movie movie = movi.service.TopMovie.topMovieByYearAndGenre(year, genreId, movieList, ratingList,LOGGER);
                System.out.println(movie.getMovieId() + " " + movie.getMovieTitle());
            }
            ...
            if (choice == 8) {
                ...
                List<Movie> top5Movies = movi.service.Top5MoviesByUserInterest.findTop5MoviesBasedOnUserInterest(userId, ratingList, movieList,LOGGER);
            }
